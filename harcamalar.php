...
$query=mysqli_query($con,"delete from expenses where expense_id='$rowid'");
if($query){
echo "<script>alert('Record successfully deleted');</script>";
echo "<script>window.location.href='harcamalar.php'</script>";
} else {
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Bugünün Harcamaları</h4>
...
?>
  ...
  display: inline-block;" href="harcamalar.php?delid=<?php echo $row['expense_id'];?>">-</a></td>
                        </tr>
                        <?php 
$cnt=$cnt+1;
}?>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Dünün Harcamaları</h4>
...
$cnt=$cnt+1;
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Son 1 Haftalık Harcama</h4>
...
$cnt=$cnt+1;
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Son 1 Aylık Harcama</h4>
...
$cnt=$cnt+1;
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Seçtiğiniz Tarih Aralığındaki Harcamalarınız</h4>
